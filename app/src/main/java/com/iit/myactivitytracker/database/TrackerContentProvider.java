...
//        MastermindContentProvider.GTASKS_TASKS_CONTENT_URI,
//        item);
//
//
//        ContentValues gTaskContentValues = new ContentValues();
//        gTaskContentValues.put(GTasksTable.G_UPDATED, updateDate);
//        gTaskContentValues.put(GTasksTasksTable.G_NOTES, description);
//        setGTasksContentValuesAction(context, gTaskContentValues,
//        recordWrapper, GTasksWrapper.SYNC_ACTION_UPDATE);
//        context.getContentResolver().update(
//        ContentUris.withAppendedId(
//        MastermindContentProvider.GTASKS_TASKS_CONTENT_URI,
//        gTaskWrapper.getId()), gTaskContentValues, null,
//        null);
//
//        getContentResolver().delete(
//        ContentUris.withAppendedId(
//        MastermindContentProvider.TAGS_CONTENT_URI, tagId),
//        null, null);
